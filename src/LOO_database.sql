...
insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Sam','Bock', 'TestPainting-2', '2004',     'Masterwork',  12.0,     34.0,   'Oil',   'computers', 20140123,         'Steve Shum', 'GSC',           10000,                50000,               20140129,   'Jessica Spalding', 'Costelo',      400000.54);
...
insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Clint',     'Freiheit',   'TestPainting-4', '1756',     'Other',  12.0,     34.0,   'Oil',   'computers', 20140125,         'Steve Shum', 'GSC',           10000,                50000,               20140127,   'Jessica Spalding', 'Costelo',      400000.54);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Clint',     'Freiheit',   'TestPainting-5', '1754',     'Masterwork',  12.0,     34.0,   'Oil',   'computers', 20140126,         'Steve Shum', 'GSC',           10000,                50000,               20140126,   'Jessica Spalding', 'Costelo',      400000.54);
...
insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Sam',     'Bock',   'TestPainting-7', '1801',     'Masterpiece',  12.0,     34.0,   'Oil',   'computers', 20130822,         'Steve Shum', 'GSC',           10000,                50000,               20140125,   'Jessica Spalding', 'Costelo',      400000.54);
...
insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Tim',     'Burwitz',   'TestPainting-9', '1525',     'Masterpiece',  12.0,     34.0,   'Oil',   'computers', 20140222,         'Steve Shum', 'GSC',           10000,                50000,               20140124,   'Jessica Spalding', 'Costelo',      400000.54);

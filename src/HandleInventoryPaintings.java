...
public abstract class HandleInventoryPaintings
{
  ...
  public static Pair[] loadMap(InventoryPainting inventory, boolean isQuery)
  {
    ...
    pairs.add(new Pair("inventory_paintings.dateOfPurchase", inventory.getDateOfPurchase()));
    ...
    pairs.add(new Pair("inventory_paintings.sold", inventory.getSoldYesOrNo()));
    pairs.add(new Pair("inventory_paintings.dateOfSale", inventory.getDateOfSale()));
    ...
    pairs.add(new Pair("inventory_paintings.flagBoughtReport", inventory.getFlagBoughtReport()));
    pairs.add(new Pair("inventory_paintings.flagSoldReport", inventory.getFlagSoldReport()));

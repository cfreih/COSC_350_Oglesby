...
values ('Sam', 'Bock', 'TestPainting-1', '1825', 'Masterpiece', 12.0, 34.0, 'Oil', 'computers', 20140122, 'Steve Shum', 'GSC', 10000, 50000, 20140128, 'Jessica Spalding', 'Costelo', 400000.54);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Sam','Bock', 'TestPainting-2', '2004',     'Masterwork',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               20140128,   'Jessica Spalding', 'Costelo',      400000.54);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Claudio',     'Arce',   'TestPainting-3', '1600?',     'Other',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               null,   null, null,      null);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Clint',     'Freiheit',   'TestPainting-4', '1756',     'Other',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               20140128,   'Jessica Spalding', 'Costelo',      400000.54);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Clint',     'Freiheit',   'TestPainting-5', '1754',     'Masterwork',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               20140128,   'Jessica Spalding', 'Costelo',      400000.54);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Steve',     'Shum',   'TestPainting-6', '1564',     'Masterwork',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               null,   null, null,      null);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Sam',     'Bock',   'TestPainting-7', '1801',     'Masterpiece',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               20140128,   'Jessica Spalding', 'Costelo',      400000.54);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Tim',     'Burwitz',   'TestPainting-8', '2001',     'Masterwork',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               null,   null, null,      null);

insert into inventory_paintings (firstName, lastName, title, dateOfWork, classification, height, width, medium, subject, dateOfPurchase, nameOfSeller, addressOfSeller, maximumPurchasePrice, actualPurchasePrice, dateOfSale, nameOfBuyer, addressOfBuyer, actualSellingPrice)
values ('Tim',     'Burwitz',   'TestPainting-9', '1525',     'Masterpiece',  12.0,     34.0,   'Oil',   'computers', 20140122,         'Steve Shum', 'GSC',           10000,                50000,               20140128,   'Jessica Spalding', 'Costelo',      400000.54);            
